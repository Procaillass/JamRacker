...
function App() {
  ...
  */
  ...
  const musicalNotes = [
    { name: "C0", midi: 21 }, { name: "C#0", midi: 22 }, { name: "D0", midi: 0 }, { name: "D#0", midi: 0 }, { name: "E0", midi: 0 }, { name: "F0", midi: 0 }, { name: "F#0", midi: 0 }, { name: "G0", midi: 0 }, { name: "G#0", midi: 0 }, { name: "A0", midi: 0 }, { name: "A#0", midi: 0 }, { name: "B0", midi: 0 },
    ...
    { name: "C8", midi: 108 }, { name: "C#8", midi: 109 }, { name: "D8", midi: 0 }, { name: "D#8", midi: 0 }, { name: "E8", midi: 0 }, { name: "F8", midi: 0 }, { name: "F#8", midi: 0 }, { name: "G8", midi: 0 }, { name: "G#8", midi: 0 }, { name: "A8", midi: 0 }, { name: "A#8", midi: 0 }, { name: "B8", midi: 0 }
  ];
      ...
      <div className="App">
        ...
        <header className="header">
          ...
          <div className="header__user">
            ...
            {localStorage.getItem("pseudo") ? <Logout /> : <Link className="button" to="/login">Login</Link>}
